...
ALTER TABLE ALUNO ADD (CPF VARCHAR2(15) CONSTRAINT ALUNO_CPF_UU UNIQUE);

UPDATE ALUNO SET DtNasc = '10/11/77' WHERE IdAluno = 10194;

ROLLBACK;

SELECT IdAluno, SUM(ValLiq) AS TOTAL_PAGO, AVG(ValLiq) AS MEDIA_PAGTO FROM PAGTO WHERE DtPagto LIKE '%07' GROUP BY IdAluno;
